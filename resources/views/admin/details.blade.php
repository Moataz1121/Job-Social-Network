...
<div class="card-body bg-light rounded-2 mt-4 shadow">
    <blockquote class="blockquote mb-0">
        <div class = "mb-3">
            <small class="fs-5"><b class="fs-4">Title: </b> {{ $post->employer->name }} </small>
        </div>
        <div class = "mb-3">
        ...
        <div class = "mb-3">
            <small class="fs-5"><b class="fs-4">Skills: </b>{{ $post->skills }}</small>
        </div>
        <div class = "mb-3">
        ...
        <div class = "mb-3">
            <small class="fs-5"><b class="fs-4">Salary: </b>{{ $post->salary }}</small>
        </div>
        <div class = "mb-3">
   ...
   <form action="{{route('admin.update' , $post->id)}}" method="POST">
    ...
    @method('patch')
    <div>
        {{-- <select  name="status" class="form-select my-3" aria-label="Default select example">
