        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form enctype="multipart/form-data" id="formAuthentication" class="mb-3" action="{{ route('employer.register') }}" method="POST">
                @csrf
                <div class="mb-3">
...
@enderror
                ...
                <div class="mb-3">
                  ...
                  <input type="file" class="form-control" id="image" name="image" placeholder="Enter your phone_number" />
                  @error('image')
    <span class="text-danger">{{ $message }}</span>
@enderror
                </div>
