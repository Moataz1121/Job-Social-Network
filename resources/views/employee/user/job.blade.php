                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="d-flex justify-content-between align-items-center w-100">
                                                ...
                                                <form id="edit-comment-{{ $comment->id }}" action="{{ route('comments.edit', $comment->id) }}" method="POST" style="display:none;">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="form-group">
                                                        <input type="text" name="body" class="form-control" value="{{ $comment->body }}" required>
                                                    </div>
