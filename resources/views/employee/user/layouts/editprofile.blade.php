        ...
        <div class="row newsfeed-size">
            <div class="col-md-12 newsfeed-right-side">
                    ...
                    <ul class="nav navbar container">
                        <ul class="d-content nav">
                            <li class="nav-item" style="margin-left: 10px">
                                <a class="btn nav-link" href="{{ route('employee.profile') }}">Profile</a>
                            </li>
                            <li class="nav-item" style="margin-left: 10px">
                                <a class="btn nav-link" href="{{ route('employee.job') }}">Posts
                                    Jobs</a>
                            </li>
                            <li class="nav-item" style="margin-left: 10px">
                                <a class="btn nav-link" href="{{ route('employee.editProfile') }}">Edit
                                    Profile</a>
                            </li>
                        </ul>
                        ...
                        @else
                            <li class="nav-item dropdown" style="margin-right:0px">
                                <a class="btn dropdown-toggle nav-link" href="#" id="navbarDropdown" role="button"
                ...
                <div class="container mt-5 ">
                    <form action="{{ route('employee.updateprofile', $user->id) }}" method="POST"
